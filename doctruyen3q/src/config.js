...
var MIRRORS = [
    "https://doctruyen3qhub.vip",
    "https://doctruyen3q.xyz",
    "https://doctruyen3qui21.com",
    "https://doctruyen3q.me"
];
...
function syncBaseFromUrl(url) {
    if (!url) return;
    var m = String(url).match(/^https?:\/\/((?:www\.)?doctruyen3q[a-z0-9-]*\.[a-z]+)/i);
    if (m) {
...
function parseItems(doc) {
    ...
    var cards = doc.select("div.item-manga, div.item, div.comic-item");
